			    ...
			    <div class="col-lg-8">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" action="<?= base_url()?>AdminSideController/gallerySubmite" method="post" enctype="multipart/form-data" data-parsley-validate="true">
								<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="fullname">Select Gallery * :</label>
									<div class="col-md-8 col-sm-8">
										<input class="form-control" type="file" id="fullname" name="image" placeholder="Required" data-parsley-required="true" />
									</div>
								</div>
								<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="fullname">Select Category * :</label>
									<div class="col-md-8 col-sm-8">
									
									<select class="form-control" style="background-color:#626263;" name="date" required>
						...
						?>
									...
									<div class="col-md-8 col-sm-8">
                                                                            ...
                                                                            <select class="form-control" style="background-color:#626263;" name="month" required>
								...
								<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="fullname">Event Name * :</label>
									<div class="col-md-8 col-sm-8">
										<input class="form-control" type="text" id="fullname" name="name" placeholder="Required" data-parsley-required="true" />
									</div>
								</div>
								<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="descr">Description * :</label>
            ...
            <div id="gallery" class="gallery">
                ...
                <div class="image gallery-group-1">
                    <div class="image-inner">
                        <a href="<?=base_url()?>assetsAdmin/img/gallery/gallery-1.jpg" data-lightbox="gallery-group-1">
                            <img src="<?=base_url()?>assetsAdmin/img/gallery/gallery-1.jpg" alt="" />
                        </a>

                    </div>
                    <div class="image-info">
						<div class="pull-right">
												<a href="#" class="btn btn-sm btn-white btn-danger width-60">Delete</a>
