			    ...
			    <div class="col-lg-8">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" action="<?= base_url()?>AdminSideController/pvideosubmit/<?=$a?>" method="post" enctype="multipart/form-data" data-parsley-validate="true">
								<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="fullname">Video url * :</label>
									<div class="col-md-8 col-sm-8">
                                                                            <input class="form-control" type="text" id="fullname" name="image" placeholder="Required" data-parsley-required="true" accept="image/*" />
                                                                            
									</div>
								</div>
								<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="fullname"> Videos Name * :</label>
									<div class="col-md-8 col-sm-8">
