                            ...
                            <form action="<?= base_url()?>AdminSideController/appointReplySubmit/<?=$id?>" method="post" enctype="multipart/form-data" class="form-horizontal" data-parsley-validate="true" name="demo-form">
								<div class="form-group row m-b-15">
									...
									<div class="col-md-8 col-sm-8">
										<input class="form-control" type="text" id="fullname" name="id" value="<?=$fname?>" data-parsley-required="true" disabled />
									</div>
								</div>
                                                                <div class="form-group row m-b-15">
								...
								<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="discr">Answer Write Here * :</label>
									
									<div class="col-md-8 col-sm-8">
                                                                            <textarea name="email" class="form-control" id="message" name="descr" rows="10" placeholder="Message Range from 20 - 400" required></textarea>
									</div>
								</div>
