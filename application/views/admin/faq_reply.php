...
<?php// include'include/header.php';?>
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Reply FAQ'S <small>Manage FAQ'S...</small></h1>
			<!-- end page-header -->
			    ...
			    <div class="col-lg-8">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                        ...
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Reply Of FAQ'S</h4>
                        </div>
                        <!-- end panel-heading -->
                        <!-- begin panel-body -->
                        <div class="panel-body">
                            <form action="<?= base_url()?>AdminSideController/faqReplySubmit/<?=$id?>" method="post" enctype="multipart/form-data" class="form-horizontal" data-parsley-validate="true" name="demo-form">
								<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="fullname">Username :</label>
									<div class="col-md-8 col-sm-8">
										<input class="form-control" type="text" id="fullname" name="id" value="<?=$name?>" data-parsley-required="true" disabled />
									</div>
								</div>
								
								<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="discr">User Question :</label>
									
									<div class="col-md-8 col-sm-8">
										<textarea class="form-control" id="message" name="discr" rows="10"  required disabled><?=$message?></textarea>
									</div>
								</div>
								...
								<div class="form-group row m-b-15">
									...
									<div class="col-md-8 col-sm-8">
										<textarea class="form-control" id="message" name="descr" rows="10" placeholder="Message Range from 20 - 400" required></textarea>
									</div>
								</div>
