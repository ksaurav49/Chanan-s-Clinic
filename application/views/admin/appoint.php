                        ...
                        <div class="panel-body">
                            <table id="data-table-colreorder" class="table table-striped table-bordered m-b-0">
                                ...
                                <tbody>
                                   <?php
                                   $i=1;
                                   $r= $this->db->query("select * from appointment order by id DESC");
									...
									<tr>
                                        ...
                                        <td class="with-btn" nowrap>
                                            ...
                                            if($row->status =="pending"){
                                                ...
                                                ?>
                                                <a href="#" class="btn btn-sm btn-white"><?=$row->status?>...</a>
                                                
                                           <?php }else{
                                          $e="disabled";
                                            ?>
						<a href="#" class="btn btn-sm btn-success"><?=$row->status?>...</a>
                                           <?php } ?>
										</td>
										<td class="with-btn" nowrap>
                                                                                    <a href="<?= base_url()?>apr/<?=$row->id?>" class="btn btn-sm btn-primary width-60 m-r-2 <?=$e?>">Reply</a>
										</td>
                                    </tr>
<?php $i++; } ?>
