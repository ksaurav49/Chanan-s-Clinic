...
<?php// include'include/header.php';?>
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">FAQ'S View Table <small>Manage FAQ'S...</small></h1>
			<!-- end page-header -->
                            ...
                            <table id="data-table-colreorder" class="table table-striped table-bordered m-b-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-nowrap">Answers</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                    	<td width="9%" class="f-s-600">1</td>
                                        <td>Hemant Chandra</td>
                                        <td>hemant@wapeen.com</td>
                                        <th>Please Send me your speciality description</th>
                                        <th>mshdugsh.kdvlisnghvjskdhbfhcs .ksjdhsjuskfj jjhnkjgcsjhgjfchbcf,vjdhkzdjh</th>
                                    </tr>
									<tr>
                                    	<td width="9%" class="f-s-600">2</td>
                                        <td>Kumar Saurav</td>
                                        <td>saurav@wapeen.com</td>
                                        <th>Please Send me your speciality</th>
                                        <th>mshdugsh.kdvlisnghvjskdhbfhcs .ksjdhsjuskfj jjhnkjgcsjhgjfchbcf,vjdhkzdjh</th>
                                    </tr>
