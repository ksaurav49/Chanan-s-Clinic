              ...
              ?>
										<tr>
											...
											<td class="with-img">
												...
												<img src="<?=base_url()?>assets/image/gallery/<?=$row->img?>" class="img-rounded height-60" />
											...
											<td class="with-btn" nowrap>
                                                                                            ...
                                                                                            <a href="<?=base_url()?>AdminSideController/galleryDelSubmit/<?=$row->id?>/<?=$row->img?>" class="btn btn-sm btn-primary width-60" style="margin-top: 3px">Delete</a>
											</td>
										</tr>
              <?php } }?>
