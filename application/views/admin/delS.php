...
<?php //include'include/header.php';?>
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Slider View Table <small>Manage Sliders...</small></h1>
			<!-- end page-header -->
			...
			<div class="row">
			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="table-basic-7">
                        ...
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Chanan's - Clinic Slider Management <span class="label label-success m-l-5 t-minus-1">NEW</span></h4>
                        </div>
                        <!-- end panel-heading -->
                        <!-- begin panel-body -->
               ...
               foreach ($query->result() as $row)
             {
              ...
              ?>
										<tr>
											<td class="with-img">
												<img src="<?=base_url()?>assets/image/slider/<?=$name?>" class="img-rounded height-60" />
											</td>
											<td>Medical</td>
											<td>Services</td>
											<td>You Can</td>
											...
											<td class="with-btn" nowrap>
                                                                                            ...
                                                                                            <a href="<?=base_url()?>AdminSideController/delSlides/<?=$i?>/<?=$name?>" class="btn btn-sm btn-primary width-60" style="margin-top: 3px">Delete</a>
											</td>
										</tr>
             <?php }?>
