...
<?php// include'include/header.php';?>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item"><a href="javascript:;">Email against appointment</a></li>
				<li class="breadcrumb-item active">Reply FAQ'S</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Email now <small>Manage Appointment...</small></h1>
			<!-- end page-header -->
			    ...
			    <div class="col-lg-8">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                        ...
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Reply Of Appointment</h4>
                        </div>
                        <!-- end panel-heading -->
                        <!-- begin panel-body -->
                        <div class="panel-body">
                            <form action="<?= base_url()?>AdminSideController/appointReplySubmit/<?=$id?>" method="post" enctype="multipart/form-data" class="form-horizontal" data-parsley-validate="true" name="demo-form">
								<div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="fullname">Patient id :</label>
									<div class="col-md-8 col-sm-8">
										<input class="form-control" type="text" id="fullname" name="id" value="<?=$id?> <?=lname?>" data-parsley-required="true" disabled />
									</div>
								</div>
                                                            <div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="fullname">Username :</label>
									<div class="col-md-8 col-sm-8">
										<input class="form-control" type="text" id="fullname" name="id" value="<?=$fname?> <?=lname?>" data-parsley-required="true" disabled />
									</div>
								</div>
                                <div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="fullname">Email :</label>
									<div class="col-md-8 col-sm-8">
										<input class="form-control" type="text" id="fullname" name="id" value="<?=$email?> <?=lname?>" data-parsley-required="true" disabled />
									</div>
								</div>
                                                                <div class="form-group row m-b-15">
									<label class="col-md-4 col-sm-4 col-form-label" for="fullname">Enter time :</label>
									<div class="col-md-8 col-sm-8">
										<input class="form-control" type="text" id="fullname" name="time"  data-parsley-required="true" />
									</div>
								</div>
